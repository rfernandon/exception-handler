...
SetupWindowTitle=%1 - Assistente de Instalação
...
MissingWOW64APIs=A versão do Windows que você está executando não inclui a funcionalidade requerida pelo Assistente de Instalação para realizar uma instalação de 64 bits. Para corrigir este problema, por favor instale o Service Pack %1.
...
SetupAppRunningError=O Assistente de Instalação detectou que %1 está sendo executado.%n%nPor favor, feche todas as instâncias do programa agora e clique em OK para continuar ou em Cancelar para sair.
...
ExitSetupTitle=Sair do Assistente de Instalação
ExitSetupMessage=A Instalação não foi concluída. Se você sair agora, o programa não será instalado.%n%nVocê pode executar o Assistente de Instalação novamente em outra hora, para concluir a instalação.%n%nSair do Assistente de Instalação ?
AboutSetupMenuItem=&Sobre o Assistente de Instalação...
...
SelectLanguageTitle=Selecionar Idioma do Assistente de Instalação
SelectLanguageLabel=Selecione o idioma a ser utilizado durante a instalação:

; *** Common wizard text
ClickNext=Clique em Avançar para continuar ou em Cancelar para sair do Assistente de Instalação.
BeveledLabel=
...
; *** "Welcome" wizard page
WelcomeLabel1=Bem-vindo ao Assistente de Instalação do programa [name]
WelcomeLabel2=Este Assistente irá instalar o programa [name/ver] no seu computador.%n%nÉ recomendado que você feche todos os outros aplicativos antes de continuar e que o computador estejá conectado a internet.
...
SelectDirDesc=Onde o programa [name] deve ser instalado ?
SelectDirLabel3=O Assistente de Instalação irá instalar o programa [name] na seguinte pasta.
...
ToUNCPathname=O Assistente de Instalação não pode fazer a instalação num caminho de rede UNC. Se você estiver tentando instalar num local de rede, deverá mapear uma unidade de rede.
...
DiskSpaceWarning=O Assistente de Instalação requer pelo menos %1 KB de espaço livre, mas a unidade de disco selecionada tem apenas %2 KB disponíveis.%n%nVocê quer continuar assim mesmo ?
...
NoUninstallWarning=O Assistente de Instalação detectou que os seguintes componentes já estão instalados em seu computador:%n%n%1%n%nDesmarcar estes componentes, não irá desinstalar eles.%n%nVocê quer continuar assim mesmo ?
ComponentSize1=%1 KB
ComponentSize2=%1 MB
...
SelectTasksLabel2=Selecione as tarefas adicionais que você deseja que o Assistente de Instalação execute enquanto instala o programa [name] e clique em Avançar.

; *** "Select Start Menu Folder" wizard page
WizardSelectProgramGroup=Selecionar a Pasta do Menu Iniciar
SelectStartMenuFolderDesc=Onde o Assistente de Instalação deve colocar os atalhos do programa ?
SelectStartMenuFolderLabel3=O Assistente de Instalação irá criar os atalhos do programa na seguinte pasta do Menu Iniciar.
...
ReadyLabel1=O Assistente de Instalação está pronto para começar a instalação do programa [name] no seu computador.
...
PreparingDesc=O Assistente de Instalação está se preparando para instalar o programa [name] no seu computador.
PreviousInstallNotCompleted=A instalação/remoção de um programa anterior não foi concluída. Você precisará reiniciar seu computador para finalizá-la.%n%nApós reiniciar o computador, execute novamente o Assistente de Instalação para concluir a instalação do programa [name].
CannotContinue=O Assistente de Instalação não pode continuar. Por favor, clique em Cancelar para sair.

; *** "Installing" wizard page
WizardInstalling=Instalando
InstallingLabel=Por favor, aguarde enquanto o Assistente de Instalação instala o programa [name] no seu computador.

; *** "Setup Completed" wizard page
FinishedHeadingLabel=Finalizando o Assistente de Instalação do programa [name]
FinishedLabelNoIcons=O Assistente de Instalação finalizou a instalação do programa [name] no seu computador.
FinishedLabel=O Assistente de Instalação terminou de instalar o programa [name] no seu computador. O programa pode ser iniciado clicando nos ícones instalados.
ClickFinish=Clique em Concluir para sair do Assistente de Instalação.
FinishedRestartLabel=Para concluir a instalação do programa [name], o Assistente de Instalação deve reiniciar o computador. Você gostaria de reiniciar agora ?
FinishedRestartMessage=Para concluir a instalação do programa [name], o Assistente de Instalação deve reiniciar o computador.%n%nVocê gostaria de reiniciar agora ?
...
SetupAborted=A instalação não foi concluída.%n%nPor favor, corrija o problema e execute novamente o Assistente de Instalação.
...
FileExists=O arquivo já existe.%n%nVocê quer que o Assistente de Instalação sobrescreva o arquivo ?
ExistingFileNewer=O arquivo já existente é mais recente do que o arquivo que o Assistente de Instalação está tentando instalar. Recomenda-se que você mantenha o arquivo existente.%n%nVocê quer manter o arquivo existente ?
...
ErrorRestartingComputer=O Assistente de Instalação não conseguiu reiniciar o computador. Por favor, reinicie o computador manualmente.
