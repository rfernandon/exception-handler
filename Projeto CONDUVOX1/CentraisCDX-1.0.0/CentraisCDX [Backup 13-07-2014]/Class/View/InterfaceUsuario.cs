...
namespace CentraisCDX.Class.View
{
    public partial class InterfaceUsuario : Form
    {
        ...
        private void btnTestarConexao_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Cursor = Cursors.WaitCursor;
                if(cc.verificarConexao((string)this.cboPortaCOM.SelectedItem))
                    MessageBox.Show("Conexão bem sucedida.", "CentralCDX", MessageBoxButtons.OK, MessageBoxIcon.Information);
                else MessageBox.Show("A central não reconheceu ao comando de conexão.", "Ops! Ocorreu um erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            catch (Exception Ex)
            {
                MessageBox.Show(Ex.Message, "Ops! Ocorreu um erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        CentraisCDX.Class.Comunicacao.TestarComunicacao t;
        private void button1_Click(object sender, EventArgs e)
        {
            t = new CentraisCDX.Class.Comunicacao.TestarComunicacao();
            t.iniciarTeste();
        ...
        private void InterfaceUsuario_KeyPress(object sender, KeyPressEventArgs e)
        {

        }

        private void InterfaceUsuario_KeyDown(object sender, KeyEventArgs e)
        {
