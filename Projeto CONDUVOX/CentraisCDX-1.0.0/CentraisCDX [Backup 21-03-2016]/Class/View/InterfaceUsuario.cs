    ...
    public partial class InterfaceUsuario : Form
    {
        ...
        private void monitor()
        {
            while (true)
            {
                ...
                {
                    if (Processo.countComandoEnviado == 32 && progressBar1.Value <= 100)
                    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            while(true) {
                ...
                if (this.number_final > 255) this.number_final = 0;

                MessageBox.Show(comando, "Ops! Ocorreu um erro", MessageBoxButtons.OK, MessageBoxIcon.None);
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(Convert.ToString(result, 16).PadLeft(2, '0').ToUpper());
            //return result;
        }
    }
}